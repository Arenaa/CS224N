...
class ParserModel(nn.Module):
    ...
    def forward(self, w):
        ...
        hidden_activation = torch.nn.functional.relu(embeddings @ self.embed_to_hidden_weight + self.embed_to_hidden_bias)
        hidden_activation_dropout = self.dropout(hidden_activation)
        logits = hidden_activation_dropout @ self.hidden_to_logits_weight + self.hidden_to_logits_bias
